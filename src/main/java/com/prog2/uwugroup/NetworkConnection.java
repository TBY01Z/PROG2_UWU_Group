    ...
    private class ConnectionThread extends Thread{
        ...
        public void run(){
            try{
                ...
                this.socket = isServer() ? server.accept() : new Socket(getIP(), getPort()); //wenn Socket "socket" ein server ist wird verbindung akzeptiert, sonst neuer Socket mit IP und Port{       //ObjectInputStream erstellt
